"""
Copy-pasting https://github.com/pytorch/vision/blob/master/torchvision/datasets/lsun.py
and fixing the error for num_workers: https://github.com/pytorch/vision/issues/689#issuecomment-621341347
"""
...
class LSUNClass(VisionDataset):
    ...
    def init_env(self):
        return lmdb.open(
            self.root, max_readers=1, readonly=True,
...
class LSUN(VisionDataset):
    ...
    def __init__(self, root, classes='train', transform=None, target_transform=None):
        ...
        for c in self.classes:
            db = LSUNClass( root=root + '/' + c + '_lmdb', transform=transform)
            self.dbs.append(db)
